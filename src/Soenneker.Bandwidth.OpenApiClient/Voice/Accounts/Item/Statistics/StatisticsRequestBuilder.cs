...
namespace Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Statistics
{
    ...
    public partial class StatisticsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Models.AccountStatistics"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.AccountStatistics?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.AccountStatistics> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Bandwidth.OpenApiClient.Models.AccountStatistics>(requestInfo, global::Soenneker.Bandwidth.OpenApiClient.Models.AccountStatistics.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns details about the current state of the account.
        /// </summary>

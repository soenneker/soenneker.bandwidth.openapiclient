...
using Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings
{
    /// <summary>
    /// Builds and executes requests for operations under \voice\accounts\{accountId}\conferences\{conferenceId}\recordings
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class RecordingsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Bandwidth.OpenApiClient.voice.accounts.item.conferences.item.recordings.item collection</summary>
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.WithRecordingItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("recordingId", position);
                return new global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.WithRecordingItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.RecordingsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice/accounts/{accountId}/conferences/{conferenceId}/recordings", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.RecordingsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RecordingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice/accounts/{accountId}/conferences/{conferenceId}/recordings", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.RecordingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.RecordingsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.RecordingsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

...
using System;
namespace Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media
{
    /// <summary>
    /// Builds and executes requests for operations under \voice\accounts\{accountId}\conferences\{conferenceId}\recordings\{recordingId}\media
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class MediaRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media.MediaRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MediaRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice/accounts/{accountId}/conferences/{conferenceId}/recordings/{recordingId}/media", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media.MediaRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MediaRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice/accounts/{accountId}/conferences/{conferenceId}/recordings/{recordingId}/media", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media.MediaRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media.MediaRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.Voice.Accounts.Item.Conferences.Item.Recordings.Item.Media.MediaRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>

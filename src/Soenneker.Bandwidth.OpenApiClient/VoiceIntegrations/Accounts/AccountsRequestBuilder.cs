...
using Soenneker.Bandwidth.OpenApiClient.VoiceIntegrations.Accounts.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.VoiceIntegrations.Accounts
{
    /// <summary>
    /// Builds and executes requests for operations under \voice-integrations\accounts
    /// </summary>
    ...
    public partial class AccountsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.VoiceIntegrations.Accounts.Item.WithAccountItemRequestBuilder this[int position]
        {
            get
            {
        ...
        public AccountsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-integrations/accounts", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoiceIntegrations.Accounts.AccountsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AccountsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-integrations/accounts", rawUrl)
        {
        }
    }
}

...
using Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions
{
    /// <summary>
    /// Builds and executes requests for operations under \shortcodes\accounts\{accountId}\shortcodes\campaigns\webhooks\subscriptions
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SubscriptionsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Bandwidth.OpenApiClient.shortcodes.accounts.item.shortcodes.campaigns.webhooks.subscriptions.item collection</summary>
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.Item.WithSubscriptionItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("subscriptionId", position);
                return new global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.Item.WithSubscriptionItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.SubscriptionsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shortcodes/accounts/{accountId}/shortcodes/campaigns/webhooks/subscriptions", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.SubscriptionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/shortcodes/accounts/{accountId}/shortcodes/campaigns/webhooks/subscriptions", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.CreateShortCodeCampaignWebhookSubscriptionResponseSchema?> PostAsync(string body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.CreateShortCodeCampaignWebhookSubscriptionResponseSchema> PostAsync(string body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.SubscriptionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.SubscriptionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.Shortcodes.Accounts.Item.Shortcodes.Campaigns.Webhooks.Subscriptions.SubscriptionsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

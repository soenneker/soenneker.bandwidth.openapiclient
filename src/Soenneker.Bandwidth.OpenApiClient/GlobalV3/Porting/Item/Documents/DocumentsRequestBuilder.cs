...
namespace Soenneker.Bandwidth.OpenApiClient.GlobalV3.Porting.Item.Documents
{
    ...
    public partial class DocumentsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Models.DocumentUploadSuccessResponseResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.DocumentUploadSuccessResponseResponse?> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.DocumentUploadSuccessResponseResponse> PostAsync(MultipartBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Bandwidth.OpenApiClient.Models.DocumentUploadSuccessResponseResponse>(requestInfo, global::Soenneker.Bandwidth.OpenApiClient.Models.DocumentUploadSuccessResponseResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// You are required to upload all the relevant documents for your existing port-in order to be successful depending on the number you are trying to port and which country the number belongs to. You can see the required documents by checking a number&apos;s portability requirements.The endpoint can only support 1 file per document type, and up to 20Mb. 
        /// </summary>

...
#nullable enable
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.BrandResponse_1?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.BrandResponse_1> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Bandwidth.OpenApiClient.Models.BrandResponse_1>(requestInfo, global::Soenneker.Bandwidth.OpenApiClient.Models.BrandResponse_1.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get details for this TCR brand (the actual details available to Bandwidth will differ substantially between import and direct customers).
        /// </summary>

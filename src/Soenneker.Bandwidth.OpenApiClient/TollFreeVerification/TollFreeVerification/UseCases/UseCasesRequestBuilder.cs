...
using System;
namespace Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases
{
    /// <summary>
    /// Builds and executes requests for operations under \toll-free-verification\tollFreeVerification\useCases
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class UseCasesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases.UseCasesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UseCasesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/toll-free-verification/tollFreeVerification/useCases", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases.UseCasesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UseCasesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/toll-free-verification/tollFreeVerification/useCases", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases.UseCasesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases.UseCasesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.TollFreeVerification.TollFreeVerification.UseCases.UseCasesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

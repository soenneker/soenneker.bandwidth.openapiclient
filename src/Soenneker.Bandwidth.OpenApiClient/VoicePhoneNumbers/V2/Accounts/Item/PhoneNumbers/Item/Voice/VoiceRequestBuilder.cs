...
using System;
namespace Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice
{
    /// <summary>
    /// Builds and executes requests for operations under \voice-phone-numbers\v2\accounts\{accountId}\phoneNumbers\{phoneNumber}\voice
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class VoiceRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice.VoiceRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VoiceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-phone-numbers/v2/accounts/{accountId}/phoneNumbers/{phoneNumber}/voice", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice.VoiceRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public VoiceRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-phone-numbers/v2/accounts/{accountId}/phoneNumbers/{phoneNumber}/voice", rawUrl)
        {
        }
        /// <summary>
        /// Returns the current state of voice features and settings provisioned for a phone number.
        /// </summary>
...
#nullable enable
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceProvisioningPhoneNumberDetailResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceProvisioningPhoneNumberDetailResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceProvisioningPhoneNumberDetailResponse>(requestInfo, global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceProvisioningPhoneNumberDetailResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns the current state of voice features and settings provisioned for a phone number.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice.VoiceRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice.VoiceRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Item.Voice.VoiceRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}

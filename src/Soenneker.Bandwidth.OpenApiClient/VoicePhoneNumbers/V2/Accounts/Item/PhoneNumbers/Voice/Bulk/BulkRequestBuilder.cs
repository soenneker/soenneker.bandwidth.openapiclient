...
using Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk
{
    /// <summary>
    /// Builds and executes requests for operations under \voice-phone-numbers\v2\accounts\{accountId}\phoneNumbers\voice\bulk
    /// </summary>
    ...
    public partial class BulkRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.Item.WithBulkItemRequestBuilder this[string position]
        {
            get
            {
                ...
                urlTplParams.Add("bulkId", position);
                return new global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.Item.WithBulkItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.BulkRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-phone-numbers/v2/accounts/{accountId}/phoneNumbers/voice/bulk", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.BulkRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BulkRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-phone-numbers/v2/accounts/{accountId}/phoneNumbers/voice/bulk", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.BulkRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.BulkRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.VoicePhoneNumbers.V2.Accounts.Item.PhoneNumbers.Voice.Bulk.BulkRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>

...
namespace Soenneker.Bandwidth.OpenApiClient.Models
{
    ...
    public partial class MoveTnsOrderJsonResponsePayload : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Bandwidth.OpenApiClient.Models.TelephoneNumberGroupJsonError>? Errors { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Bandwidth.OpenApiClient.Models.TelephoneNumberGroupJsonError> Errors { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Bandwidth.OpenApiClient.Models.JsonWarning>? Warnings { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Bandwidth.OpenApiClient.Models.JsonWarning> Warnings { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Models.MoveTnsOrderJsonResponsePayload"/> and sets the default values.
        /// </summary>
        public MoveTnsOrderJsonResponsePayload()
        {
        ...
        public static global::Soenneker.Bandwidth.OpenApiClient.Models.MoveTnsOrderJsonResponsePayload CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Bandwidth.OpenApiClient.Models.MoveTnsOrderJsonResponsePayload();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "errors", n => { Errors = n.GetCollectionOfObjectValues<global::Soenneker.Bandwidth.OpenApiClient.Models.TelephoneNumberGroupJsonError>(global::Soenneker.Bandwidth.OpenApiClient.Models.TelephoneNumberGroupJsonError.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "warnings", n => { Warnings = n.GetCollectionOfObjectValues<global::Soenneker.Bandwidth.OpenApiClient.Models.JsonWarning>(global::Soenneker.Bandwidth.OpenApiClient.Models.JsonWarning.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Bandwidth.OpenApiClient.Models.TelephoneNumberGroupJsonError>("errors", Errors);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Bandwidth.OpenApiClient.Models.JsonWarning>("warnings", Warnings);

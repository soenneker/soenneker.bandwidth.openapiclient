...
namespace Soenneker.Bandwidth.OpenApiClient.Models
{
    ...
    public partial class VoiceDebugLogsError : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>Reserved for a finer-grained application-specific code (NOT theHTTP status). Not currently populated — `type` carries the errorcategory today.</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsErrorSource? Source { get; set; }
#nullable restore
#else
        public global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsErrorSource Source { get; set; }
#endif
        /// <summary>Machine-readable error category. Consistent across occurrences of the same problem.</summary>
        public global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsErrorType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsError"/> and sets the default values.
        /// </summary>
        public VoiceDebugLogsError()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsError"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsError CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Bandwidth.OpenApiClient.Models.VoiceDebugLogsError();
        }
        /// <summary>

...
namespace Soenneker.Bandwidth.OpenApiClient.Models
{
    ...
    public partial class CheckoutCartResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The productCheckoutList property</summary>
...
#nullable restore
        ...
        public static global::Soenneker.Bandwidth.OpenApiClient.Models.CheckoutCartResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Bandwidth.OpenApiClient.Models.CheckoutCartResponse();
        }
        /// <summary>

...
using System;
namespace Soenneker.Bandwidth.OpenApiClient.MessagingTransfer.Accounts.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \messaging-transfer\accounts\{accountId}
    /// </summary>
    ...
    public partial class WithAccountItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public WithAccountItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/messaging-transfer/accounts/{accountId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.MessagingTransfer.Accounts.Item.WithAccountItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithAccountItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/messaging-transfer/accounts/{accountId}", rawUrl)
        {
        }
    }
}

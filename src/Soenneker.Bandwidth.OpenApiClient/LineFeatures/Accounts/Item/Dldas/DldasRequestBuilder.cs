...
namespace Soenneker.Bandwidth.OpenApiClient.LineFeatures.Accounts.Item.Dldas
{
    ...
    public partial class DldasRequestBuilder : BaseRequestBuilder
    {
        ...
        public DldasRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/line-features/accounts/{accountId}/dldas{?page*,size*,suggestions*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.LineFeatures.Accounts.Item.Dldas.DldasRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public DldasRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/line-features/accounts/{accountId}/dldas{?page*,size*,suggestions*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/line-features/accounts/{accountId}/dldas?phoneNumber={phoneNumber}{&page*,size*,suggestions*}", PathParameters);

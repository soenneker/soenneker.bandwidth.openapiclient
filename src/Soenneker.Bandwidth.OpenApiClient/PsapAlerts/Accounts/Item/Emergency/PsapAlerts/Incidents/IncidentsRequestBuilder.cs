...
using Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents
{
    /// <summary>
    /// Builds and executes requests for operations under \psap-alerts\accounts\{accountId}\emergency\psap-alerts\incidents
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class IncidentsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Bandwidth.OpenApiClient.psapAlerts.accounts.item.emergency.psapAlerts.incidents.item collection</summary>
        /// <param name="position">The unique pre-existing incident identifier</param>
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.Item.WithIncidentItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("incidentId", position);
                return new global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.Item.WithIncidentItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IncidentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/psap-alerts/accounts/{accountId}/emergency/psap-alerts/incidents{?incidentId*,limit*,offset*,triggeredOnly*,triggeredTestAlertsOnly*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IncidentsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/psap-alerts/accounts/{accountId}/emergency/psap-alerts/incidents{?incidentId*,limit*,offset*,triggeredOnly*,triggeredTestAlertsOnly*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder.IncidentsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder.IncidentsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve all PSAP Outage Alert Incidents and alert information for an account. PSAP Outage Alert Incidents are returned in descending order by createdAt, and grouped by incidentId.
        /// </summary>
        ...
        {
            /// <summary>Returns PSAP Outage Alert Incidents matching the incidentId substring</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
            [QueryParameter("incidentId")]
...
#nullable restore
            ...
            /// <summary>Only return triggered alerts</summary>
            [QueryParameter("triggeredOnly")]
            public bool? TriggeredOnly { get; set; }
            /// <summary>Only return triggered test alerts</summary>
            [QueryParameter("triggeredTestAlertsOnly")]
            public bool? TriggeredTestAlertsOnly { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class IncidentsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Soenneker.Bandwidth.OpenApiClient.PsapAlerts.Accounts.Item.Emergency.PsapAlerts.Incidents.IncidentsRequestBuilder.IncidentsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.

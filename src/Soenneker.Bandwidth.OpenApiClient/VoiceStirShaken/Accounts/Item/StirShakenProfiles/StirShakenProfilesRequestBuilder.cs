...
using Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles
{
    /// <summary>
    /// Builds and executes requests for operations under \voice-stir-shaken\accounts\{accountId}\stirShakenProfiles
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class StirShakenProfilesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Bandwidth.OpenApiClient.voiceStirShaken.accounts.item.stirShakenProfiles.item collection</summary>
        ...
        public global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.Item.WithStirShakenProfileItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("stirShakenProfileId", position);
                return new global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.Item.WithStirShakenProfileItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.StirShakenProfilesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StirShakenProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-stir-shaken/accounts/{accountId}/stirShakenProfiles", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.StirShakenProfilesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StirShakenProfilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/voice-stir-shaken/accounts/{accountId}/stirShakenProfiles", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <exception cref="global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse">When receiving a 404 status code</exception>
        /// <exception cref="global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse">When receiving a 405 status code</exception>
        /// <exception cref="global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse">When receiving a 409 status code</exception>
        /// <exception cref="global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse">When receiving a 5XX status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<global::Soenneker.Bandwidth.OpenApiClient.Models.StirShakenProfilesResponse> PostAsync(global::Soenneker.Bandwidth.OpenApiClient.Models.StirShakenProfilesRequestData body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "404", global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse.CreateFromDiscriminatorValue },
                { "405", global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse.CreateFromDiscriminatorValue },
                { "409", global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse.CreateFromDiscriminatorValue },
                { "5XX", global::Soenneker.Bandwidth.OpenApiClient.Models.Voice_stir_shaken_errorResponse.CreateFromDiscriminatorValue },
            };
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.StirShakenProfilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.StirShakenProfilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Bandwidth.OpenApiClient.VoiceStirShaken.Accounts.Item.StirShakenProfiles.StirShakenProfilesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StirShakenProfilesRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        ...
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class StirShakenProfilesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
